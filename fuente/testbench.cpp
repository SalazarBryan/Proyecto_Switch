...
// Funci�n para crear una trama espec�fica
...
// Funci�n de auto-verificaci�n (self-checking)
void selfCheck(hls::stream<ethernet_frame> output_port_streams[MAX_PORTS]) {
// Esta funci�n deber�a implementar la l�gica para verificar la correcci�n de las tramas de salida
// Implementa aqu� tu l�gica de verificaci�n
std::cout << "Iniciando verificaci�n del comportamiento de salida del switch..." << std::endl;
// Nota: esta parte est� simplificada y debe ser completada seg�n los requisitos espec�ficos del proyecto
}
...
// Función para imprimir estados intermedios
